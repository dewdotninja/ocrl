...
<ul>
<ul>
<li />5.1 การหาแนววิถีเหมาะที่สุดโดยอ้อม
 <ul>
  <li />5.1.1 การจัดการกับเงื่อนไขบังคับในวิธี DDP
  </ul>
 <li />5.2 ปัญหาเวลาน้อยสุด
  <li />5.3 การหาแนววิถีเหมาะที่สุดโดยตรง
   <ul>
    <li />5.3.1 วิธีการจัดวางโดยตรง
   </ul>
<li />5.4 การสร้างเสถียรภาพให้แนววิถี
 <ul>
  <li />5.4.2 การป้อนกลับเฉพาะที่โดยตัวควบคุม LQR แบบแนวนอนจำกัด
  </ul>
<li />5.5 สรุปท้ายบท
<li />บรรณานุกรม
<li />โจทย์ปัญหา
...
* [บทที่ 6](/doc/notebooks/chapter6.ipynb) การหาค่าเหมาะที่สุดของการหมุน
<ul>
 <ul>
 <li />6.1 การกำหนดทิศทาง
 <ul>
  <li />6.1.1 เมทริกซ์การหมุน
   <li />6.1.2 จลนศาสตร์การหมุน
 </ul>
 <li />6.2 ควอเทอร์เนียน
 <ul>
<li />6.2.1 การคูณควอเทอร์เนียน
<li />6.2.2 ควอเทอร์เนียนสังยุค
<li />6.2.3 การหมุนเวกเตอร์โดยควอเทอร์เนียน
<li />6.2.4 จลนศาสตร์ควอเทอร์เนียน
<li />6.2.5 เรขาคณิตของควอเทอร์เนียน
 </ul>
  <li />6.3 การหาอนุพันธ์ควอเทอร์เนียน
   <li />6.4 การใช้ตัวควบคุม LQR ร่วมกับควอเทอร์เนียน
  <li />6.5 สรุปท้ายบท
  <li />บรรณานุกรม
  <li />โจทย์ปัญหา
 </ul>
...
* [บทที่ 7](/doc/notebooks/chapter7.ipynb) พลวัตสัมผัสและพื้นฐานการเคลื่อนที่ของขาหุ่นยนต์

* [บทที่ 8](/doc/notebooks/chapter8.ipynb) การควบคุมเหมาะที่สุดแบบสโทแคสติก
 ...
 <ul>
   ...
   <li />C.1.3 การประมาณค่าโมเดลเชิงเส้น
    <li />C.1.4 คำนวณอนุพันธ์ผ่านฟังก์ชันรุงเงอ คุตตา
     <li />C.1.5 การคำนวณเฮสเซียนเชิงสัญลักษณ์
 </ul>
</ul>
</ul>
...
#### บทที่ 5 
* [บทที่ 5 (part I)](https://youtu.be/1Ok0PgoppTQ) วิธีโดยอ้อมในการหาแนววิถีเหมาะที่สุดสำหรับระบบไม่เป็นเชิงเส้น
* [บทที่ 5 (part II)](https://youtu.be/rBVyLih9yqg) วิธีโดยตรงในการหาแนววิถีเหมาะที่สุดสำหรับระบบไม่เป็นเชิงเส้น
#### บทที่ 6
